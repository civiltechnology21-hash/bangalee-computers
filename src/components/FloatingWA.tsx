...
export default function FloatingWA() {
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="wa-pulse w-14 h-14 rounded-full bg-[#25d366] hover:bg-[#20bd5a] flex items-center justify-center shadow-xl cursor-pointer transition-transform hover:scale-110">
